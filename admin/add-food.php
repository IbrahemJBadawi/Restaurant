    ...
    if (isset($_POST['submit'])) {
        ...
        $q = "INSERT INTO food (title , Price, Image , Featured , Active, cat_id, Description) VALUES
         ('$title',  '$price', '$image_name', '$featured', '$active', '$cat_id', '$description');";
        $res = mysqli_query($conn, $q);
        if ($res) {
            $_SESSION['food'] = "<h4 class='success'>food added</h4>";
            header("LOCATION:manage-food.php");
        } else {
            $_SESSION['food'] =  "<h4 class='success'>food not added</h4>";
            header("LOCATION:manage-food.php");
        }
    };
    ?>